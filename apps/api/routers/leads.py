...
def _get_lead_or_404(lead_id: str) -> LeadRecord:
    """Obtiene un lead existente o lanza un 404 si no se encuentra."""
...
def route_lead(lead_id: str) -> RouterOutput:
    """Ejecuta el flujo de routing híbrido y actualiza el lead."""
...
def compose_response(lead_id: str, request: ComposeRequest) -> ComposerOutput:  # noqa: ARG001
    """Genera la respuesta simulada y guarda el score resultante."""
...
def send_message(lead_id: str, request: SendRequest) -> SendResponse:
    """Registra en logs un envío simulado y devuelve un identificador."""
...
def export_leads(format: str = "csv") -> ExportResponse:
    """Devuelve la ubicación ficticia de la última exportación disponible."""
